...
session_auth = usdt_perpetual.HTTP(
    ...
    api_key='sx1JOogXw6lk0aaFUV',
    api_secret='noZhivthLzvUSKhxW1ImaT8Fl1OeO0D9B0FB'
)
session_unauth = usdt_perpetual.HTTP(
    endpoint="https://api.bybit.com"
)
...
session_auth_2 = usdt_perpetual.HTTP(
    endpoint="https://api.bybit.com",
    api_key='2iedFnVXqtccaNMvut',
    api_secret='dFWth1ty9jqrevGDBVSnfEMiGypvGDk6jQam'
)
                ...
                if '#SHORT' in new_message or '#LONG' in new_message:
                    ...
                    if 'Take Profit' in new_message:
                        ...
                        try:
                            ...
                            order_ignat = float(balance_ignat) / 100 * 4
